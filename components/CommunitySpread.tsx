    ...
    <div id="lan-toa" className="md:col-span-5 bg-white rounded-3xl p-5 sm:p-6 border border-slate-200/80 shadow-sm flex flex-col justify-between space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3.5">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-2xl bg-gradient-to-tr from-[#1e3a8a] to-[#0284c7] text-white flex items-center justify-center shadow-xs">
            <span className="text-lg">🌐</span>
          </div>
          <div>
            <h3 className="font-extrabold text-sm sm:text-base uppercase text-[#1e3a8a] tracking-wide flex items-center gap-1.5">
            ...
            <p className="text-[11px] text-slate-500 font-medium">
              Đã có <span className="font-bold text-[#0284c7]">{totalCount.toLocaleString("vi-VN")}+</span> Thầy Cô & Học sinh tham gia ký cam kết
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-xl border border-slate-200 hover:border-sky-300 bg-slate-50 hover:bg-sky-50 text-slate-700 hover:text-[#0284c7] text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-[#0284c7] to-[#1e3a8a] hover:from-[#0369a1] hover:to-[#172554] text-white text-xs font-bold transition-all shadow-sm shadow-sky-500/25 flex items-center gap-1.5 cursor-pointer active:scale-95"
          >
