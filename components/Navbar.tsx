...
export default function Navbar() {
  ...
  return (
    <>
            ...
            <Link href="/" className="flex items-center gap-2.5 shrink-0 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] sm:text-[11px] text-slate-500 font-medium">
                  An toàn hôm nay - Tương lai ngày mai
                </span>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-2.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-36 xl:w-44 bg-slate-100/90 hover:bg-slate-100 focus:bg-white focus:w-52 transition-all duration-200 border border-slate-200 rounded-full pl-3.5 pr-8 py-1.5 text-xs text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-sky-500/30"
                />
                <button 
                  type="button"
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-sky-600"
                  aria-label="Tìm kiếm"
                >
              ...
              >
                ...
                <span className="absolute top-1 right-1 w-4 h-4 bg-[#ef4444] text-white text-[9px] font-bold rounded-full flex items-center justify-center border-2 border-white animate-pulse">
                  3
                </span>
              </button>
              ...
              <div className="flex items-center gap-2 pl-1 border-l border-slate-200">
                <div className="w-8 h-8 rounded-full overflow-hidden border border-sky-400 shadow-xs">
                  <img
                ...
                <div className="flex flex-col text-left">
                  <span className="text-[10px] text-slate-400 leading-none">Xin chào!</span>
                  <span className="text-xs font-bold text-[#1e3a8a] leading-tight">Học sinh</span>
                </div>
              </div>
          ...
          <div className="xl:hidden bg-white border-b border-slate-200 px-4 py-3 space-y-2 shadow-lg animate-in fade-in slide-in-from-top-2 duration-150">
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold transition-all ${
                      isActive
                        ...
                        : "text-slate-700 hover:bg-slate-50 bg-slate-50/60"
                    }`}
                  >
            ...
            <div className="flex items-center justify-between pt-1">
              <Link
                href="/admin"
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center gap-2 text-xs font-semibold text-slate-600 hover:text-[#0284c7]"
              >
              ...
              <a
                href="tel:111"
                className="flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-[#ef4444] text-white"
              >
      ...
      <nav className="xl:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200 px-2 py-1 flex justify-around items-center shadow-lg">
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center py-1 text-[10px] font-bold transition-all ${
                isActive ? "text-[#0284c7]" : "text-slate-500 hover:text-slate-800"
              }`}
            >
