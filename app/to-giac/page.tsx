  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8">
      ...
      <div className="bg-white border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 self-start md:self-auto bg-rose-50 border border-rose-200 rounded-2xl px-4 py-2.5 text-xs text-rose-700 font-bold shrink-0">
      ...
      <div className="bg-gradient-to-r from-rose-50/70 via-white to-amber-50/70 border border-rose-100 rounded-2xl p-4 sm:p-5 text-xs text-slate-700 space-y-3 shadow-2xs">
        ...
        <div className="pt-2 flex flex-wrap items-center gap-3 font-semibold border-t border-slate-200/60 text-xs">
          <span className="text-slate-500">Khẩn cấp gọi ngay:</span>
          <a href="tel:111" className="text-rose-600 hover:underline flex items-center gap-1 font-bold">
      ...
      {isSuccess ? (
        <div className="bg-white border border-emerald-200 rounded-3xl p-8 sm:p-10 text-center space-y-4 shadow-sm animate-in fade-in duration-300">
        ...
        >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-rose-600 to-red-700 hover:from-rose-700 hover:to-red-800 text-white font-extrabold py-4 px-6 rounded-2xl text-xs sm:text-sm shadow-md shadow-red-500/25 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
          >
